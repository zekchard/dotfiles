...
Aside from installing [the packages below](#most-packages-used), this dotfiles
repo is managed by [chezmoi](https://www.chezmoi.io/) so if you clone this repo
you will have to manually rename the directories modified by it (ie.
`private_dot_config` to `.config`) before using it.\
You can also download the tar from
[releases](https://github.com/zekchard/dotfiles/releases/latest) and untar it in
your home directory.

## (most) packages used

> [!IMPORTANT]
> This assumes that you are using these dotfiles with Arch Linux et al., also
> highly recommended that you have [chaotic-aur](https://aur.chaotic.cx)
> installed in your pacman repos
...
|                                      | `chaotic-aur/gpu-screen-recorder-gtk-git`                                                                                                    |
